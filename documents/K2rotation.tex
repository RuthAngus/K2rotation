...
The bottom panel shows the LS\footnote{All LS periodograms
...
periodogram of this light curve, after
...
20,000 sinusoids with periods between 1 to 30 days and amplitudes ranging from
...
This is partly due to the fact that the sensitivity of any periodic signal
search method will decrease towards longer rotation periods due to the finite
length of the light curves and partly because some of the periodic signal
can be described by the ELCs alone.
This issue is addressed further in \textsection\ref{section:rotation}.
A caveat of these injection tests is that a single sinusoid with
a constant amplitude over the full 80 day baseline of campaign 1 may not
necessarily be a realistic model of acoustic modes in giant stars, however
average mode lifetimes in giants are often tens of days
\citep[e.g.][]{Chaplin2009}, and therefore comparable to the length of a
{\it K2} campaign.
On the other hand, constant-amplitude sinusoids certainly not representative
of typical stellar variability.
% Real signals, therefore are likely to be less easy to detect.
These injection tests are therefore a best-case representation of the
ability of the SIP to recover real astrophysical signals.
...
stellar rotation ($\sim$ 1 - 30 days), we are most complete at the shortest
