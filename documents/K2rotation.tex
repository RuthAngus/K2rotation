...
\newcommand{\Ninjections}{1000}
\newcommand{\minamp}{100}
\newcommand{\maxamp}{300}
...
We performed some injection and recovery tests in order to test the detection
efficiency of the SIP algorithm.
\Ninjections sinusoids with frequencies ranging from 10-260\uHz and
amplitudes ranging from \minamp to \maxamp were injected into the raw \ktwo\
light curve of target star EPIC 201121245, a relatively non-variable giant
with low-amplitude acoustic oscillations.
In order to recover the injected signals we calculated a SIP of the original
light curve and subtracted this from the SIP of the light curve, after
injection and searched for excess power in the residuals.
