...
of an active, rotating star, EPIC 201317002.
...
% add some things about more tests?
...
It is a pleasure to thank Andrew Vanderburg (Harvard) and Ben Montet (Harvard)
...
period of 20.33 days for this star. {\it Bottom}: The LS periodogram
...
\caption{{\it Top}: Raw light curve of EPIC 201133037. {\it Bottom}: A
...
the periodogram is centred at 24.61 days.}
...
\begin{figure*}
\begin{center}
\includegraphics[width=6in, clip=true]{201133037_top5.pdf}
\caption{The 5 highest-weighted ELCs for EPIC 201133037. At least 3 of these
	ELCs show sinusoidal variability with a $\sim$ 10 day period.
	The light curve of EPIC 201133037 is therefore easily described by the
