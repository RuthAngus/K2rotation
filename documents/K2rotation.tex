...
close to 6 hours.
The method it is not currently well optimized for measuring longer periods,
due to the fact that many ELCs are dominated by periodic variations on the
same timescales as the rotation periods.
A regularized version of the SIP algorithm may improve performance for
measuring stellar rotation periods.
