...
\caption{Lomb-scargle periodogram of the raw {\it K2} (Top) and detrended
	 (bottom) photometry for EPIC 201183188. The light curve was
 	 detrended using the method of \citet{Vanderburg2014}.}
\label{fig:raw}
\end{center}
\end{figure*}
