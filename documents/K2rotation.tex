...
systematic trends, described by a certain conbination of the ELCs, at the best
...
and does better than producing periodogram from detrended data.
...
that almost completely free from instrumental systematics signals, without the
need for detrending.
...
\caption{{\it Top}: Light curve of EPIC \rpc, detrended using the method
	...
	The autocorrelation function method measures a rotation period of 6
	days for this star.
	{\it Bottom}: The LS periodogram of the detrended light curve.
	The highest peak in the periodogram is located at 54 days and is likely
...
\caption{{\it Top}: The raw light curve of EPIC \rpc\ is shown in grey and
	...
	range of frequencies, measuring a rotation period of 7 days.
