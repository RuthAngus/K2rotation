...
% precise pointing by using the Solar wind to stabilise the spacecraft and only
...
% Within each field there are thousands of variable, rotating, pulsating
% and exoplanet hosting stars, all with periodic behaviour.
...
% Many fields of were enormously advanced (asteroseismology in particular) by its
% excellent precision.
...
% SIPs of the raw data were produced by calculating the S/N of the amplitudes of
% single sine and cosine functions, plus 150 ELCs conditioned on the data at
